		...
		<div class="panel-heading"> 
			...
			<form method="post" action="include/konsumen/action_konsumen_edit.php">
				...
				<div class="form-group">
					...
					<input  type="date" class="form-control form-control-sm" id="colFormLabelSm" placeholder="ttl" name="ttl" value="<?php echo $data['ttl'] ?>" required="" value="<?= date('d F y'); ?>">
				</div>
				<div class="form-group">
					<label>nohp</label>
					<input type="text" name="nohp" value="<?php echo $data['nohp'] ?>" class="form-control" placeholder="Masukkan nomer hp">
				</div>
